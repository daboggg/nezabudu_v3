...
delete_reminder_handlers = Router()

@delete_reminder_handlers.callback_query(F.data.startswith("cancel_remind"))
async def delete_reminder(callback: CallbackQuery, apscheduler: AsyncIOScheduler):
